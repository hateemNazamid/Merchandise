            ...
            <div class="form-container">
                ...
                <form action="UpdateCustomerServlet" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="username" class="form-control" value="${customer.getUsername()}" required>
                    </div>
                    <div class="form-group">
                        <label>Password:</label>
                        <input type="password" name="password" class="form-control" value="${customer.getPassword()}" required>
                    </div>
                    <div class="form-group">
                        <label>Address:</label>
