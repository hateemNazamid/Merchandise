            ...
            <%
                ...
                try {
                    ...
                    while (rs.next()) {
                        ...
                        String image = rs.getString("IMAGE"); // assume image is path or blob id
            ...
            <div class="card">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        %>
                        <tr>
                            <td><img src="MerchImageServlet?id=<%= merchID%>" alt="Image" class="thumbnail"></td>
                            <td><%= merchID%></td>
                            <td><%= name%></td>
                            <td><%= category%></td>
                        ...
                        <%
                            ...
                            if (openTable) {
                                out.println("</tbody></table></div>"); // Close last card
                            }
